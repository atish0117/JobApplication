          ...
          {role === "Employer" && (
            ...
            <div className="max-w-4xl mx-auto my-8 p-6 bg-white rounded-lg shadow-lg border border-gray-200">
              ...
              <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                {[
                  { label: 'Organization', icon: FaBuilding, value: profile.orgName },
                  { label: 'Full Name', icon: FaUser, value: profile.FullName },
                  { label: 'Email', icon: FaEnvelope, value: profile.email },
                  { label: 'Contact', icon: FaPhoneAlt, value: profile.Contact },
                  { label: 'Skills', icon: FaCogs, value: profile.skills },
                  { label: 'Industry', icon: FaIndustry, value: profile.industry },
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  {jobPosts.map((post) => (
                    ...
                    >
                      ...
                      <p className="text-sm text-gray-600">
                        <strong>Responsibilities:</strong> {post.keyResponsibility}
                      </p>
                      <p className="text-sm text-gray-600">

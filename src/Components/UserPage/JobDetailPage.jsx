      ...
      <div className="p-6 max-w-3xl mx-5  bg-white shadow-md rounded">
        ...
        <div className=" w-full py-2 ">
          <div className="w-full flex flex-col sm:flex-row  h-[300px] pl-8 ">
            ...
            {imagePreviewURL && (
              <div className="img mt-6 w-full sm:w-1/4 flex flex-col justify-start items-center ">
                ...
                <div className="rounded-full bg-slate-500 overflow-hidden flex items-center justify-center w-40 h-40">
                  {imagePreviewURL ? (
                    ...
                    <div className="w-full h-full flex items-center justify-center bg-gray-200">
                      <FaBuilding size={40} className="text-gray-500" />
                    </div>
                  )}
                </div>
            ...
            <div className="details w-full sm:ml-8  flex flex-col justify-center ">
            ...
            <div className="w-full h-64 overflow-y-auto">
              ...
              >
                ...
                <p className="break-words">
                  {job.jobDescription}
                  ghggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggg
                </p>
              </div>
            </div>
          </div>
